...
## Validator for IEC 61850 SCL 2003 (version 1.1.0 a23 - 13 October 2021, a Java 8 JRE is required)
...
* Download [this jar file](downloads/RiseClipseValidatorSCL-1.1.0-a23.jar) somewhere
* Use it (`java -jar RiseClipseValidatorSCL-1.1.0-a23.jar`) in a Terminal/Cmd window; the command line arguments are given in a usage message. More details on [command lines](commandLineHelp) to use
...
* Download and unzip [this archive](downloads/RiseClipseValidatorSCLApplication-1.1.0-a23.zip) somewhere
